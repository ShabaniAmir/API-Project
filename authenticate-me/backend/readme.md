...
- Request
  ...
  - Method: PUT
  - URL: /api/groups/:groupdId/venues/:venueId
  - Headers:
    - Content-Type: application/json
  - Body:
...
- Request
  ...
  - Method: POST
  - URL: /api/groups/:groupId/events/:eventId/images
  - Headers:
    - Content-Type: application/json
  - Body:
...
- Request
  ...
  - Method: GET
  - URL: /api/groups/:groupId/events/:eventId/attendees
  - Body: none
